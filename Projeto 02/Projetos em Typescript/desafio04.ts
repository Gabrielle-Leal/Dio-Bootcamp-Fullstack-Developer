// Um desenvolvedor tentou criar um projeto que consome a base de dados de filme do TMDB para 
//criar um organizador de filmes, mas desistiu pois considerou o seu código inviável. 
...
// Todas as requisições necessárias para as atividades acima já estão prontas, mas a implementação 
//delas ficou pela metade (não vou dar tudo de graça).
